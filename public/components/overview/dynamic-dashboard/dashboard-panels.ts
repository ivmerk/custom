...
const getVisStateAlertsEvolution = (indexPatternId: string, ruleGroup: string) => {
  return {
    ...
    data: {
      ...
      aggs: [
        ...
        },
        {
          ...
          params: {
            field: 'rule.groups',
            customLabel: `${ruleGroup} rule group`,
            orderBy: '1',
            order: 'desc',
            size: 5,
            otherBucket: false,
...
export const getDynamicDashboardPanels = (
  ...
  const pinnedAgentPanels = {
    '1': {
      ...
      explicitInput: {
        id: '1',
        savedVis: getVisStateAlertsEvolution(indexPatternId, ruleGroup),
      },
    },
  };
  const panels = {
